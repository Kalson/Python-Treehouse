...
"""
try - A keyword that marks a block of code to be tried that will watch for
exceptions to happen.
len - gets the length of something like a string
except - A keyword that catches exceptions and runs some other code when one
happens.
Exception - A catchable/predictable mistake in code, like trying to turn the
string 'a' into a number, which would throw a ValueError exception.
...
Index - The position of something inside of something else. This will be a
number and counting starts at zero.
"""
